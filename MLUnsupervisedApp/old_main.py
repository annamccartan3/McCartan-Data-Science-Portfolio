...
X_std = scaler.fit_transform(X)
    ...
    if 'df' in st.session_state:
        df = st.session_state['df']
        st.sidebar.subheader("Choose Features")
        ...
        if drop_cols is None:
            drop_cols = []
        default_features = [col for col in df.columns if col not in drop_cols and col != st.session_state['target_col']]
        ...
        st.session_state['y'] = df[st.session_state['target_col']]
